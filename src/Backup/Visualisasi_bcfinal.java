...
public class Visualisasi_bcfinal extends javax.swing.JFrame {
    private koneksi db = new koneksi();
    int id_pesan = 1;
    int id_biner = 1;
    
    public Visualisasi_bcfinal() {
        initComponents();
    ...
    private void VISUALISASIMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VISUALISASIMouseClicked
        Visualisasi_bcfinal vs = new Visualisasi_bcfinal();
        vs.setVisible(true);
        vs.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Visualisasi_bcfinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Visualisasi_bcfinal().setVisible(true);
            }
        });
    }
